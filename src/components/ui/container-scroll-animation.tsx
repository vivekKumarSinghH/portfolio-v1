...
import { FaCss3, FaDocker, FaHtml5, FaNode, FaReact } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex justify-center items-center">
          <IoLogoFirebase className="text-4xl text-black" />
        </div>
        <div className="flex justify-center items-center">
        ...
        <div className="flex justify-center items-center">
          <SiPostman className="text-4xl text-black" />
        </div>
        <div className="flex justify-center items-center">
          <TbBrandVscode className="text-4xl text-black" />
        </div>

        <div className="flex justify-center items-center">
          <FaDocker className="text-4xl text-black" />
        </div>
